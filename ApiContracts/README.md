...
**Файлы контрактов:** `user.proto`, `listing.proto`, `booking.proto`, `notification.proto`, `review.proto`.  
**Сводка endpoints:** [API-Contracts-Endpoints.md](API-Contracts-Endpoints.md).
